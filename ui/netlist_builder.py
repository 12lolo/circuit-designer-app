...
class NetlistBuilder:
    ...
    def build_netlist(self, scene: QGraphicsScene) -> Dict:
        ...
        # Collect all components and connection points
        components = []
        wires = []
        junction_points = []
        ...
        for item in scene.items():
            if hasattr(item, 'component_type'):
                ...
                junction_points.append(item)

        # Build connectivity map
        connectivity = self._build_connectivity_map(components, wires, junction_points)
    ...
    def _build_connectivity_map(self, components, wires, junction_points) -> Dict:
        """
